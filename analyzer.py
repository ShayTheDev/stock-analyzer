...
# Convert the imported CSV file to a 2D NumPy array while skipping the first 3 rows
...
print("Average stock's closing price is:",mean_close.round(2),
      "\nAverage stock's opening price is:", mean_open.round(2))
# Median(Value)
...
print("Standard deviation for closing is:",std_close.round(2),
      "\nStandard deviation for opening is:",std_open.round(2))
# Correlation(close,open)
